...
|黄奈子ちゃん&nbsp;(<-have a space at end)|jamp to 黃奈子ちゃん if the byte at data pointer is zero|[|while(\*ptr){|
|黃奈子ちゃん&nbsp;(<-have a space at end)|jamp to 黄奈子ちゃん if the byte at data pointer is zero|]|}|
